...
public class KnowledgeBaseVectorService {
    ...
    public List<Document> similaritySearch(String query, List<Long> knowledgeBaseIds, int topK, double minScore) {
        ...
        try {
            ...
            List<Document> filtered = filterAndLimitResults(results, knowledgeBaseIds, topK);
            log.info("搜索完成: 找到 {} 个相关文档", filtered.size());
            return filtered;
    ...
    private List<Document> similaritySearchFallback(String query, List<Long> knowledgeBaseIds, int topK, double minScore) {
        ...
        try {
            ...
            List<Document> results = filterAndLimitResults(allResults, knowledgeBaseIds, topK);
    ...
    private List<Document> filterAndLimitResults(List<Document> results, List<Long> knowledgeBaseIds, int topK) {
